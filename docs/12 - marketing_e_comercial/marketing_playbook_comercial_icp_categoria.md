# Marketing e Comercial — Playbook Comercial — ICP por categoria

## 1. Definição

Este arquivo aprofunda o subtema **Playbook Comercial**, com foco específico em **icp por categoria**.
...
Definir ICP e sinais de fit por categoria de parceiro.
...
- como a WeeeMob deve estruturar icp por categoria?
...
- icp por categoria está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Playbook Comercial — ICP por categoria da WeeeMob.
