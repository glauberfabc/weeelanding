# Marketing e Comercial — Funil de Parceiro — Score de lead/parceiro

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Parceiro**, com foco específico em **score de lead/parceiro**.
...
Definir score de potencial e risco para parceiro.
...
- como a WeeeMob deve estruturar score de lead/parceiro?
...
- score de lead/parceiro está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Funil de Parceiro — Score de lead/parceiro da WeeeMob.
