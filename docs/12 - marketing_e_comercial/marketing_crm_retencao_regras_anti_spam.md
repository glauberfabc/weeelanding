# Marketing e Comercial — CRM e Retenção — Regras anti-spam

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **regras anti-spam**.
...
Definir limites e frequência de comunicação.
...
- como a WeeeMob deve estruturar regras anti-spam?
...
- regras anti-spam está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — Regras anti-spam da WeeeMob.
