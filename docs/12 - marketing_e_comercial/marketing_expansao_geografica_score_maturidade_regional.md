# Marketing e Comercial — Expansão Geográfica — Score de maturidade regional

## 1. Definição

Este arquivo aprofunda o subtema **Expansão Geográfica**, com foco específico em **score de maturidade regional**.
...
Definir score para saber quando uma região está saudável.
...
- como a WeeeMob deve estruturar score de maturidade regional?
...
- score de maturidade regional está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Expansão Geográfica — Score de maturidade regional da WeeeMob.
