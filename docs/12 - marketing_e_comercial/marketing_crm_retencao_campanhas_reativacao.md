# Marketing e Comercial — CRM e Retenção — Campanhas de reativação

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **campanhas de reativação**.
...
Especificar campanhas de retorno de usuários e parceiros.

## 4. Escopo

- reativação usuário
- reativação parceiro
- pós-queda de atividade
...
- como a WeeeMob deve estruturar campanhas de reativação?
...
- campanhas de reativação está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — Campanhas de reativação da WeeeMob.
