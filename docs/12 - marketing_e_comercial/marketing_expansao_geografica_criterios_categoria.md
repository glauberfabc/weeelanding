# Marketing e Comercial — Expansão Geográfica — Critérios por categoria

## 1. Definição

Este arquivo aprofunda o subtema **Expansão Geográfica**, com foco específico em **critérios por categoria**.
...
Definir critérios diferentes por categoria ao abrir uma região.
...
- como a WeeeMob deve estruturar critérios por categoria?
...
- critérios por categoria está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Expansão Geográfica — Critérios por categoria da WeeeMob.
