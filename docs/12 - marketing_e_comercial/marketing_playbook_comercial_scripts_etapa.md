# Marketing e Comercial — Playbook Comercial — Scripts por etapa

## 1. Definição

Este arquivo aprofunda o subtema **Playbook Comercial**, com foco específico em **scripts por etapa**.
...
Definir scripts comerciais por momento do pipeline.
...
- como a WeeeMob deve estruturar scripts por etapa?
...
- scripts por etapa está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Playbook Comercial — Scripts por etapa da WeeeMob.
