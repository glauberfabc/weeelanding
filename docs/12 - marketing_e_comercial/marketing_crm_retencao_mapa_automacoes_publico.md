# Marketing e Comercial — CRM e Retenção — Mapa de automações por público

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **mapa de automações por público**.

Este ramo aprofunda automações, comunicação e retenção de usuários e parceiros.
...
Definir automações separadas para usuário e parceiro.
...
- como a WeeeMob deve estruturar mapa de automações por público?
...
- mapa de automações por público está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — Mapa de automações por público da WeeeMob.
