# Marketing e Comercial — CRM e Retenção — Gatilhos por evento

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **gatilhos por evento**.
...
Definir eventos que iniciam comunicações automáticas.
...
- como a WeeeMob deve estruturar gatilhos por evento?
...
- gatilhos por evento está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — Gatilhos por evento da WeeeMob.
