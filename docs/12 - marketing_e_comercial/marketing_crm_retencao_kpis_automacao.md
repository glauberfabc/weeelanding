# Marketing e Comercial — CRM e Retenção — KPIs por automação

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **kpis por automação**.
...
Definir métricas por automação e campanha de CRM.
...
- como a WeeeMob deve estruturar kpis por automação?
...
- kpis por automação está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — KPIs por automação da WeeeMob.
