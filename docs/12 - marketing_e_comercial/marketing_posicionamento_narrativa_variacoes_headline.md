# Marketing e Comercial — Posicionamento e Narrativa — Variações de headline

## 1. Definição

Este arquivo aprofunda o subtema **Posicionamento e Narrativa**, com foco específico em **variações de headline**.
...
Gerar linhas de abertura para LPs e anúncios.

## 4. Escopo

- headline por público
- headline por categoria
- headline por intenção
...
- como a WeeeMob deve estruturar variações de headline?
...
- variações de headline está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Posicionamento e Narrativa — Variações de headline da WeeeMob.
