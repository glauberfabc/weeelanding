# Marketing e Comercial — Playbook Comercial — KPIs por vendedor/etapa

## 1. Definição

Este arquivo aprofunda o subtema **Playbook Comercial**, com foco específico em **kpis por vendedor/etapa**.

Este ramo aprofunda o motor comercial de aquisição e fechamento de parceiros.
...
Definir métricas operacionais do time comercial.
...
- como a WeeeMob deve estruturar kpis por vendedor/etapa?
...
- kpis por vendedor/etapa está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Playbook Comercial — KPIs por vendedor/etapa da WeeeMob.
