# Marketing e Comercial — Dashboards e Attribution — Taxonomia de eventos

## 1. Definição

Este arquivo aprofunda o subtema **Dashboards e Attribution**, com foco específico em **taxonomia de eventos**.
...
Definir taxonomia oficial de eventos de growth.
...
- como a WeeeMob deve estruturar taxonomia de eventos?
...
- taxonomia de eventos está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Dashboards e Attribution — Taxonomia de eventos da WeeeMob.
