# Marketing e Comercial — Funil de Usuário — Eventos por etapa

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Usuário**, com foco específico em **eventos por etapa**.
...
Definir eventos de tracking para cada etapa do funil.
...
- como a WeeeMob deve estruturar eventos por etapa?
...
- eventos por etapa está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Funil de Usuário — Eventos por etapa da WeeeMob.
