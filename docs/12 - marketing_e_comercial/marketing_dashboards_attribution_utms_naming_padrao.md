# Marketing e Comercial — Dashboards e Attribution — UTMs e naming padrão

## 1. Definição

Este arquivo aprofunda o subtema **Dashboards e Attribution**, com foco específico em **utms e naming padrão**.
...
Definir convenções de naming e UTMs.
...
- como a WeeeMob deve estruturar utms e naming padrão?
...
- utms e naming padrão está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Dashboards e Attribution — UTMs e naming padrão da WeeeMob.
