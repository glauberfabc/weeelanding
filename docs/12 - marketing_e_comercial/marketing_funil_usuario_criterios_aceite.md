# Marketing e Comercial — Funil de Usuário — Critérios de aceite

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Usuário**, com foco específico em **critérios de aceite**.
...
Definir quando este ramo do funil está suficientemente especificado.
...
```text
Quero aprofundar o branch Funil de Usuário — Critérios de aceite da WeeeMob.
