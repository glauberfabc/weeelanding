# Marketing e Comercial — Funil de Usuário — Dashboards

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Usuário**, com foco específico em **dashboards**.
...
Definir dashboards do funil de usuário.
...
- como a WeeeMob deve estruturar dashboards?
...
- painéis oficiais
- cortes por canal/cidade/categoria
- drill-down mínimo
...
- dashboards está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Funil de Usuário — Dashboards da WeeeMob.
