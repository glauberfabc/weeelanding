# Marketing e Comercial — Funil de Parceiro — Critérios de qualificação

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Parceiro**, com foco específico em **critérios de qualificação**.
...
Definir critérios para aceitar ou priorizar leads e parceiros.
...
- como a WeeeMob deve estruturar critérios de qualificação?
...
- critérios de qualificação está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Funil de Parceiro — Critérios de qualificação da WeeeMob.
