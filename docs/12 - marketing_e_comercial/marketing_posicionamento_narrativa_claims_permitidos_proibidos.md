# Marketing e Comercial — Posicionamento e Narrativa — Claims permitidos e proibidos

## 1. Definição

Este arquivo aprofunda o subtema **Posicionamento e Narrativa**, com foco específico em **claims permitidos e proibidos**.
...
Definir o que a WeeeMob pode afirmar e o que deve evitar.
...
- como a WeeeMob deve estruturar claims permitidos e proibidos?
...
- lista permitidos/proibidos
- regras de revisão
- riscos jurídicos/comunicacionais
...
- claims permitidos e proibidos está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Posicionamento e Narrativa — Claims permitidos e proibidos da WeeeMob.
