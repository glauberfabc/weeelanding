# Marketing e Comercial — Posicionamento e Narrativa — Mensagens principais e secundárias

## 1. Definição

Este arquivo aprofunda o subtema **Posicionamento e Narrativa**, com foco específico em **mensagens principais e secundárias**.
...
Organizar a hierarquia de mensagens por público e canal.
...
- como a WeeeMob deve estruturar mensagens principais e secundárias?
...
- mensagens principais e secundárias está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch Posicionamento e Narrativa — Mensagens principais e secundárias da WeeeMob.
