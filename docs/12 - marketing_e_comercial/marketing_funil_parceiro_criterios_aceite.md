# Marketing e Comercial — Funil de Parceiro — Critérios de aceite

## 1. Definição

Este arquivo aprofunda o subtema **Funil de Parceiro**, com foco específico em **critérios de aceite**.
...
Definir quando o ramo está suficientemente fechado.
...
```text
Quero aprofundar o branch Funil de Parceiro — Critérios de aceite da WeeeMob.
