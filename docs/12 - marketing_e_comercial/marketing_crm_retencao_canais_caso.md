# Marketing e Comercial — CRM e Retenção — Canais por caso

## 1. Definição

Este arquivo aprofunda o subtema **CRM e Retenção**, com foco específico em **canais por caso**.
...
Definir qual canal usar em cada situação.
...
- como a WeeeMob deve estruturar canais por caso?
...
- canais por caso está definido de forma clara e utilizável;
...
```text
Quero aprofundar o branch CRM e Retenção — Canais por caso da WeeeMob.
